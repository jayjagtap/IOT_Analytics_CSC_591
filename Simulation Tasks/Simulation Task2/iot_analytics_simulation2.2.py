# -*- coding: utf-8 -*-
"""
IOT_analytics_simulation task 2.2
Author: Jay Jagtap
"""
...
def simulation_random(simulation_values):
  ...
  remaining_service_time=-1*simulation_values["remaining_service_time"]*math.log(r)
  interarrivaltime_rt = -1*simulation_values["interarrivaltime_rt"]*math.log(r)
  interarrivaltime_nonrt = -1*simulation_values["interarrivaltime_nonrt"]*math.log(r)
  servicetime_rt = -1*simulation_values["servicetime_rt"]*math.log(r)
  servicetime_nrt = -1*simulation_values["servicetime_nrt"]*math.log(r)
...
if __name__ == '__main__':
  ...
  simulation_random(simulation_values)